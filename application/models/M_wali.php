...
class M_wali extends CI_Model{
    ...
    public function editGuru($kd_wali,$request)
    {
        // data $request dan $kd_wali akan dimasukan pada fungsi editGuru ini melalui controller.
    ...
    public function deleteGuru($kd_wali)
    {
        // data $request dan $kd_wali akan dimasukan pada fungsi deleteGuru ini melalui controller.
        $this->db->where('kd_wali', $kd_wali);
